...
Gapminder Data Analyzer is a desktop Java application that used Gapminder data (www.gapminder.org) from a MySQL database, to show comparative charts between different metrics and countries, between specific time periods.
